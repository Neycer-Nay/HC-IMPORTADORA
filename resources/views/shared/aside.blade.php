            ...
            <li class="dropdown">
                ...
                <ul class="dropdown-menu">
                    <li><a class="nav-link" href="#"><i
                                class="fas fa-file-invoice-dollar"></i> Recibos</a></li>
                    <li><a class="nav-link" href="#"><i
                                class="fas fa-arrow-down"></i> Ingresos</a></li>
                    <li><a class="nav-link" href="#"><i class="fas fa-arrow-up"></i>
                            Egresos</a></li>
                    <li><a class="nav-link" href="#"><i
                                class="fas fa-chart-line"></i> Reportes</a></li>
                </ul>
            </li>
        </ul>
