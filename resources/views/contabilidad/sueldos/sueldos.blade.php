                        ...
                        <tr class="{{ $sueldo->tipo_pago == 'anticipo' ? 'table-warning' : ($sueldo->tipo_pago == 'pago_final' ? 'table-success' : '') }}">
                            ...
                            <td>
                                @if($sueldo->saldo_pendiente > 0)
                                    <span class="text-danger">{{ number_format($sueldo->saldo_pendiente, 2) }} Bs</span>
                                @else
                                    <span class="text-success">0.00 Bs</span>
                                @endif
                            </td>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="nombre_trabajador" class="form-control" value="{{ request('nombre_trabajador') }}" placeholder="Nombre del trabajador...">
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <select name="tipo_pago" class="form-control">
                                    ...
                                    <option value="salario_completo" {{ request('tipo_pago') == 'salario_completo' ? 'selected' : '' }}>Salario Completo</option>
                                    <option value="anticipo" {{ request('tipo_pago') == 'anticipo' ? 'selected' : '' }}>Anticipos</option>
                                    <option value="pago_final" {{ request('tipo_pago') == 'pago_final' ? 'selected' : '' }}>Pago Final</option>
                                </select>
                            </div>
                        </div>
                    </div>
...
$(document).ready(function () {
    ...
    // Cargar sueldo base automáticamente al seleccionar trabajador
