...
<div class="main-content">
    <section class="section">
        <div class="section-header">
            <h1 style="color:#151414"><i class="fas fa-clipboard-list"></i> Detalle de Recepción N° {{ $recepcion->numero_recepcion }}</h1>
        ...
        <div class="section-body">
            ...
            <div class="card card-primary shadow-sm mb-4">
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-6">
                            <p><strong><i class="fas fa-calendar-alt"></i> Fecha Recepción:</strong> {{ \Carbon\Carbon::parse($recepcion->fecha_ingreso)->format('d/m/Y') }}</p>
                            <p><strong><i class="fas fa-clock"></i> Hora Recepción:</strong> {{ \Carbon\Carbon::parse($recepcion->hora_ingreso)->format('H:i') }}</p>
                        </div>
                        <div class="col-md-6">
                            <p><strong><i class="fas fa-user"></i> Cliente:</strong> {{ $recepcion->cliente->nombre }}</p>
                            <p><strong><i class="fas fa-user-tie"></i> Atendido por:</strong> {{ optional($recepcion->usuario)->nombre ?? 'N/A' }}</p>
                        </div>
                    </div>
                </div>
            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-5 border-end">
                                    <div class="equipo-info p-3">
                                        ...
                                        <div class="mt-3">
                                            <h6 class="text-success"><i class="fas fa-exclamation-triangle"></i> Información Adicional</h6>
                                            <ul class="list-unstyled">
                                                <li><strong>Partes Faltantes:</strong> {{ $equipo->partes_faltantes ?? 'N/A' }}</li>
                                                <li><strong>Observaciones:</strong> {{ $equipo->observaciones ?? 'N/A' }}</li>
                                            </ul>
                                        </div>
                                    </div>
                                </div>
